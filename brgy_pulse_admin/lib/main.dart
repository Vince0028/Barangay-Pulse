    ...
    return ThemeData(
      ...
      colorScheme: dark
          ? const ColorScheme.dark(
              primary: AdminColors.primary, secondary: AdminColors.warning,
              surface: Color(0xFF1C1C1F), error: AdminColors.danger)
          : const ColorScheme.light(
              primary: AdminColors.primary, secondary: AdminColors.warning,
              surface: Colors.white, error: AdminColors.danger),
      useMaterial3: true,
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          ...
          return GoogleFonts.inter(fontSize: 11,
            fontWeight: sel ? FontWeight.w600 : FontWeight.w400,
            color: sel ? AdminColors.primary : textMuted);
        }),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: dark ? const Color(0xFF1C1C1F) : const Color(0xFFF9FAFB),
